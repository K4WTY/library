...
function lib:MainWindow(text)
    ...
    mainframe.BackgroundColor3 = Color3.fromRGB(43,48,70)
    ...
    leftframe.BackgroundColor3 = Color3.fromRGB(0, 174, 234)
    ...
    tabholder.BackgroundColor3 = Color3.fromRGB(0, 174, 234)
    ...
    function window:Tab(title)
        ...
        tab.BackgroundColor3 = Color3.fromRGB(232, 168, 7)
        ...
        scrollframe.ScrollBarImageColor3 = Color3.fromRGB(43,48,70)
        ...
        container.BackgroundColor3 = Color3.fromRGB(43,48,70)
        ...
        function tab:Toggle(text, toggled, callback)
            ...
            fill.BackgroundColor3 = Color3.fromRGB(0, 174, 234)
        ...
        function tab:Slider(text, min, max, callback)
            ...
            slidingframe.BackgroundColor3 = Color3.fromRGB(0, 174, 234)
        ...
        function tab:Dropdown(name, list, callback)
            ...
            dropdownscrollframe.ScrollBarThickness =7
            dropdownscrollframe.TopImage = "rbxasset://textures/ui/Scroll/scroll-middle.png"
            dropdownscrollframe.ScrollBarImageColor3 = Color3.fromRGB(255, 190, 0)
